...
const leistungen=[
    ...
    new Leistung("Esalenmassage (90 Minuten)", 6, "95€"), new Leistung("Homöopathische Erstanamnese", 8, "175€"),
    ...
    new Leistung("Telefontermin akut", 1, "25€"), new Leistung("Kopf- und Gesichtsmassage", 2, "40€")
    ]; 
